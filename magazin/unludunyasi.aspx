<%@ Page Title="" Language="C#" MasterPageFile="~/anasayfamaster.Master" AutoEventWireup="true" CodeBehind="unludunyasi.aspx.cs" Inherits="magazin.unludunyasi" ValidateRequest="false" %>
    ...
    <section>
        <div>
            <div class="ptb-0">
                ...
                <a class="mt-10 color-ash" href="#"><i class="mlr-10 ion-chevron-right"></i><b> > Ünlü Dünyası</b></a>
            ...
            <tr>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="3" GridLines="None" AllowPaging="True" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" Height="118px" OnPageIndexChanging="GridView1_PageIndexChanging" Width="539px" PageSize="15" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellSpacing="1">
                    <Columns>
                        ...
                        <asp:BoundField DataField="magazinad" HeaderText="Ünlü Dünyası" />
            ...
            <tr>
                ...
                <td class="auto-style11"><%Response.Write(ictemiz4); %>
                    </td>
            </tr>
            <tr>
