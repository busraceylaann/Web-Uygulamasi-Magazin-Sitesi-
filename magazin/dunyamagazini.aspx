<%@ Page Title="" Language="C#" MasterPageFile="~/anasayfamaster.Master" AutoEventWireup="true" CodeBehind="dunyamagazini.aspx.cs" Inherits="magazin.dunyamagazini" ValidateRequest="false" %>
    ...
    <section>
        <div>
            <div class="ptb-0">
                ...
                <a class="mt-10 color-ash" href="#"><i class="mlr-10 ion-chevron-right"></i><b> > Dünya Magazini</b></a>
            ...
            <tr>
                ...
                <td class="auto-style11"><%Response.Write(magazinad); %>
                    </td>
            ...
            <tr>
                ...
                <td class="auto-style11"><%Response.Write(ictemiz3); %>
                    </td>
            </tr>
            <tr>
