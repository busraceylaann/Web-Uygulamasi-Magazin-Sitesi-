...
namespace magazin
{
    public partial class sitemap : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            xr.WriteElementString("loc", "http://localhost:59383");
            ...
            OleDbCommand komut2 = new OleDbCommand("select magazinid,magazinad,magazintarih from  magazinler", baglanti);
            baglanti.Open();
            OleDbDataReader oku2 = komut2.ExecuteReader();
            while (oku2.Read())
            {
                xr.WriteStartElement("url");
                xr.WriteElementString("loc", "http://localhost:59383/yasam.aspx?magazinid" + oku2.GetInt32(0).ToString());
