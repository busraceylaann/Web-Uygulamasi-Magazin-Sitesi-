...
namespace magazin
{
    public partial class moda : System.Web.UI.Page
    {
        ...
        public static StringBuilder ictemiz = new StringBuilder();
        DataSet ds = new DataSet();
        int magazinid;
        public string magazinad;
        void vericek()
        {
            string seckomut = "Select m.magazinid,m.magazinad,m.magazinicerik,m.magazintarih,m.resim, ü.üyekullanıcıad from magazinler as[m],üye as [ü] where ü.üyeid=m.üyeid and m.magazintür='Moda' and magazindurum='onaylandı' ORDER BY m.magazintarih DESC";
            ds.Clear();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ictemiz.Append(ds.Tables[0].Rows[kayitno]["magazinicerik"].ToString());
